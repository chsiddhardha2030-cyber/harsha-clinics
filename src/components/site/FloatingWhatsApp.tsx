...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center h-16 w-16 rounded-full bg-[#25D366] text-white shadow-[0_8px_32px_rgba(37,211,102,0.35)] hover:shadow-[0_12px_40px_rgba(37,211,102,0.55)] transition-all duration-300 hover:scale-110 active:scale-95 group border border-white/20"
    >
